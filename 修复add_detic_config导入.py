...
print("=" * 60)
print("修复 add_detic_config 导入问题")
print("=" * 60)
...
try:
    ...
    # 正确的导入方式：从 detic.config 导入，不是从 detic 导入
    ...
    print("=" * 60)
    print("\n💡 关键修复:")
    print("   ❌ 错误: from detic import add_detic_config")
    print("   ✅ 正确: from detic.config import add_detic_config")
    print("\n💡 下一步:")
